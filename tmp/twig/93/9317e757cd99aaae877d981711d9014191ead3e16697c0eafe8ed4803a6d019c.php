    ...
    <fieldset class=\"tblFooters print_ignore text-left\">
      <form action=\"";
        ...
        ";
            ...
            // line 508
            echo "        ";
            $___internal_ebf2f34e1ec0b14a38273a5d5309fa0bb4c4e8a43b100d8916bf3fa71036e297_ = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
            // line 506
            echo sprintf($___internal_ebf2f34e1ec0b14a38273a5d5309fa0bb4c4e8a43b100d8916bf3fa71036e297_, "<input class=\"mx-2\" type=\"number\" name=\"added_fields\" value=\"1\" min=\"1\" required>");
            // line 509
            echo "
...
";
    ...
    {
        return new Source("", "table/structure/display_structure.twig", "C:\\UniServerZ\\schule\\home\\us_opt1\\templates\\table\\structure\\display_structure.twig");
    }
}
